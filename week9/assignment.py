...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  8 13:46:55 2020
...
def test1():
    ...
    for i, problem in enumerate(problems):
        ...
        actual_result = ""
        expected_result = solutions[i]
        if status:
            number_string = ""
            acum_count = sum(len(n) for n in board.values())
            if acum_count > len(problem):
                continue
            ...
            print("Compare Actual with Expected:\n", actual_result == expected_result)
...
def test2():
    ...
    for i, problem in enumerate(problems):
        ...
        if status:
            ...
            #print("Actual Result:\n")
            #print_sudoku(number_string)
            #print("Expected Result:\n")
            #print_sudoku(expected_result)
